...
def _get_config(args):
    ...
    if checkpoint not in _config_cache:
        ...
        _config_cache[checkpoint] = {
            "global_attn_layers": attention_layout.global_attn_layers,
            "local_head_dim": attention_layout.local_head_dim,
            "global_head_dim": attention_layout.global_head_dim,
            "num_attention_heads": hf_text.num_attention_heads,
            "local_num_kv_heads": attention_layout.local_num_kv_heads,
            "global_num_kv_heads": attention_layout.global_num_kv_heads,
