...
# Trainer-side publish helpers for disk-level delta weight sync. The vLLM receive side lives in
# vime.backends.vllm_utils.local_checkpoint and runs in one Ray actor on every rollout host.
